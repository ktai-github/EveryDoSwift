...
//    newtoDo.timestamp = Date()
  ...
  override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> ToDoTableViewCell {
    var cell = ToDoTableViewCell()
    cell = tableView.dequeueReusableCell(withIdentifier: "Cell", for: indexPath) as! ToDoTableViewCell
